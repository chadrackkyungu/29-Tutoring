                                            ...
                                            <Card className='tour-card'>
                                                <CardBody>
                                                    ...
                                                    <div className="d-flex justify-content-between">
                                                        <div>
                                                            <h5>{session?.title}</h5>
                                                            <p>Code : {session?.courseCode} </p>
                                                        </div>
                                                    </div>
                                                    <div className="d-flex justify-content-between">
                                                        <Link to={`/vsdk-details/${session?._id}`} className="btn btn-red text-danger"> Go Live <BsArrowRightCircle size={18} />
                                                        </Link>
                                                        <div className='remove-bookmark'
                                                            onClick={() => deleteSession(course?._id)}>
