            ...
            <AvForm className="form-horizontal mt-4" onValidSubmit={(e, v) => { handleValidSubmit(e, v) }}>
                <Row>
                    ...
                    <Col md={6}>
                        ...
                        <div className="mb-3">
                            <AvField name="sessionTitle" label="Session Title" type="text" className="form-control" placeholder="Session title" />
                        </div>
                        <div className="mb-3">
                            <AvField name="startTime" label="Start Time" type="time" className="form-control" />
                        </div>
                        <Row>
                            <Col md={6}>
                                <div className="mb-3">
                                    <AvField name="startDate" label="Start Date" type="date" className="form-control" />
                                </div>
                            </Col>
                            <Col md={6}>
                                <div className="mb-3">
                                    <AvField name="endDate" label="End Date" type="date" className="form-control" />
                                </div>
                            </Col>
                        </Row>
