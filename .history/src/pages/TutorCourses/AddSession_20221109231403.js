...
import { CreateSessionMsg } from "components/NotifyMessage";
...
function AddCourse({ reFetch, onClose }) {
    ...
    const handleValidSubmit = (e, values) => {
        ...
        execute(endPoint, raw, Method, CreateSessionMsg, token)
    }
    ...
    return (
        <div>
            <AvForm className="form-horizontal mt-4" onValidSubmit={(e, v) => { handleValidSubmit(e, v) }}>
                <Row>
                    ...
                    <Col md={6}>
                        <Row>
                            ...
                            <Col md={6}>
                                <div className="mb-3">
                                    <AvField name="endTime" label="End Time" type="time" required className="form-control" />
                                </div>
                            </Col>
                        </Row>
                    </Col>
                ...
                <div className="mb-3">
                    <AvField name="description" label="Session Description" type="textarea" rows={3} className="form-control" required />
                </div>
