...
const AdminProfile = () => {
    ...
    function handleValidSubmit2(e, values) {
        ...
        execute(endPoint, raw, Method, UpdatePasswordMsg)
    }
    if (data?.status === "success") { history.push(LoginRoute) }
    ...
    return (
        <Layout>
            <Container fluid>
                <CardBody>
                    <AvForm className="m-5" onValidSubmit={(e, v) => { handleValidSubmit(e, v) }}>
                        <Card>
                            <CardBody>
                                <Row>
                                    <Col md={4}>
                    ...
                    <AvForm className="m-5" onValidSubmit={(e, v) => { handleValidSubmit2(e, v) }}>
                        <Card>
                            <CardBody>
