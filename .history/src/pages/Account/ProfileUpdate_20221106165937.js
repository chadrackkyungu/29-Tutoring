...
import usePostFormateData from "hooks/usePostFormateDate";
...
const UpdateProfile = () => {
    ...
    const { execute, pending, data } = usePostFormateData()
    ...
    function handleValidSubmit(e, values) {
        ...
        execute(endPoint, formdata, Method, updateProfileMsg, token)
    }
