        ...
        <Layout>
            <React.Fragment>
                <div className="page-content">
                    <MetaTagComp title_sco={TutorCourses} />
                    <Container fluid>
                        <CardBody>
                            <Link to="/dashboard" className='mt-3'> <BsArrowLeft /> Back </Link>
                            <h4 className='mb-5'> TUTOR : {data[0]?.Tutor?.firstName} {data[0]?.Tutor?.lastName} </h4>
                            {
