    ...
    return (
        <CardBody>
            ...
            <SmallModal
                ...
                cancel="No"
                CourseForm={<DeleteFormFunc reFetch={reFetch} UserID={secId} onClose={() => setSuspend(false)} />}
            />
            ...
            <SmallModal
                ...
                ModalTitle="Are you sure you want to suspend this tutor ?"
                cancel="No"
                CourseForm={<DeleteFormFunc reFetch={reFetch} UserID={secId} onClose={() => setUnSuspend(false)} />}
            />
