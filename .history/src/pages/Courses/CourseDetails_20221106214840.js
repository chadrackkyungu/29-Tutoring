...
const Properties = () => {
    ...
    console.log(`${API_user_Img}${data?.Tutor?.photo}`)
        ...
        <Layout>
            <React.Fragment>
                ...
                <Container fluid className="py-4">
                    ...
                    <Card className="d-flex p-3 px-5">
                        <img src={`${API_user_Img}${data?.Tutor?.photo}`} alt="" width="100" height="100" />
                        <div>
                            <p> <b>  Tutor name </b>: {data?.Tutor?.firstName} {data?.Tutor?.lastName}</p>
