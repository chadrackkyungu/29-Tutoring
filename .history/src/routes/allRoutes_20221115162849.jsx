...
import GoLive from "pages/Admin/TutorDetails"
import TutorDetails from "pages/TutorCourses/GoLive"
...
const userRoutes = [
  ...
  { path: TutorRoute, exact: true, component: GoLive },
  { path: TutorGoLiveRoute, exact: true, component: TutorDetails },
  { path: StudentsGoLiveRoute, exact: true, component: JoinSession },
